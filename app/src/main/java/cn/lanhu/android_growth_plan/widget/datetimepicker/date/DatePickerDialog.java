package cn.lanhu.android_growth_plan.widget.datetimepicker.date;
...
import cn.lanhu.android_growth_plan.widget.datetimepicker.CalendarUtils;
...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
    ...
    private void adjustDayInMonthIfNeeded(int month, int year) {
        ...
        int daysInMonth = CalendarUtils.getDaysInMonth(month, year);
        if (day > daysInMonth) {
	...
	private void setCurrentView(int currentView, boolean forceRefresh) {
		...
		case MONTH_AND_DAY_VIEW:
			ObjectAnimator monthDayAnim = CalendarUtils.getPulseAnimator(mMonthAndDayView, 0.9F, 1.05F);
			if (mDelayAnimation) {
            ...
            CalendarUtils.tryAccessibilityAnnounce(mAnimator, mSelectDay);
            break;
		case YEAR_VIEW:
			ObjectAnimator yearAnim = CalendarUtils.getPulseAnimator(mYearView, 0.85F, 1.1F);
			if (mDelayAnimation) {
            ...
            CalendarUtils.tryAccessibilityAnnounce(mAnimator, mSelectYear);
            break;
		}
	}
	...
	private void updateDisplay(boolean announce) {
        ...
        if (announce) {
            ...
            CalendarUtils.tryAccessibilityAnnounce(mAnimator, fullDateText);
        }
	}
	...
	public void setYearRange(int minYear, int maxYear) {
		if (maxYear < minYear)
			throw new IllegalArgumentException("Year end must be larger than year startRecord");
		if (maxYear > MAX_YEAR)
