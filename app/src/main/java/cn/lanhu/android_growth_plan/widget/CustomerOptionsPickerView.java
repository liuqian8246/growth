...
public class CustomerOptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private OnOptionCancelListener optionCancelListener;

    public void setOptionCancelListener(OnOptionCancelListener optionCancelListener) {
        this.optionCancelListener = optionCancelListener;
    }
    ...
    //构造方法
    public CustomerOptionsPickerView(CustomerOptionsPickerView.Builder builder) {
        super(builder.context);
        this.optionsSelectListener = builder.optionsSelectListener;
        this.optionCancelListener = builder.optionCancelListener;
    ...
    public static class Builder {
        ...
        private CustomerOptionsPickerView.OnOptionsSelectListener optionsSelectListener;
        private CustomerOptionsPickerView.OnOptionCancelListener optionCancelListener;
        ...
        public Builder(Context context, CustomerOptionsPickerView.OnOptionsSelectListener listener) {
            this.context = context;
            this.optionsSelectListener = listener;
        }

        //Required
        public Builder(Context context, CustomerOptionsPickerView.OnOptionsSelectListener listener,OnOptionCancelListener cancelListener) {
            this.context = context;
            this.optionsSelectListener = listener;
            this.optionCancelListener = cancelListener;
        }

        public CustomerOptionsPickerView.Builder setOptionCancelListener(OnOptionCancelListener optionCancelListener) {
            this.optionCancelListener = optionCancelListener;
            return this;
        }
        ...
        public CustomerOptionsPickerView.Builder setSubmitText(String Str_Cancel) {
            this.Str_Submit = Str_Cancel;
            return this;
        }

        public CustomerOptionsPickerView.Builder setCancelText(String Str_Cancel) {
            this.Str_Cancel = Str_Cancel;
            return this;
        }

        public CustomerOptionsPickerView.Builder setTitleText(String Str_Title) {
            this.Str_Title = Str_Title;
            return this;
        }

        public CustomerOptionsPickerView.Builder isDialog(boolean isDialog) {
            this.isDialog = isDialog;
            return this;
        }

        public CustomerOptionsPickerView.Builder setSubmitColor(int Color_Submit) {
            this.Color_Submit = Color_Submit;
            return this;
        }

        public CustomerOptionsPickerView.Builder setCancelColor(int Color_Cancel) {
         ...
         * @return
         */
        public CustomerOptionsPickerView.Builder setBackgroundId(int backgroundId) {
         ...
         * @return
         */
        public CustomerOptionsPickerView.Builder setDecorView(ViewGroup decorView) {
            this.decorView = decorView;
            return this;
        }


        public CustomerOptionsPickerView.Builder setLayoutRes(int res, CustomListener listener) {
            this.layoutRes = res;
            this.customListener = listener;
            return this;
        }

        public CustomerOptionsPickerView.Builder setBgColor(int Color_Background_Wheel) {
            this.Color_Background_Wheel = Color_Background_Wheel;
            return this;
        }

        public CustomerOptionsPickerView.Builder setTitleBgColor(int Color_Background_Title) {
            this.Color_Background_Title = Color_Background_Title;
            return this;
        }

        public CustomerOptionsPickerView.Builder setTitleColor(int Color_Title) {
            this.Color_Title = Color_Title;
            return this;
        }

        public CustomerOptionsPickerView.Builder setSubCalSize(int Size_Submit_Cancel) {
            this.Size_Submit_Cancel = Size_Submit_Cancel;
            return this;
        }

        public CustomerOptionsPickerView.Builder setTitleSize(int Size_Title) {
            this.Size_Title = Size_Title;
            return this;
        }

        public CustomerOptionsPickerView.Builder setContentTextSize(int Size_Content) {
            this.Size_Content = Size_Content;
            return this;
        }


        public CustomerOptionsPickerView.Builder setOutSideCancelable(boolean cancelable) {
         ...
         */
        @Deprecated
        public CustomerOptionsPickerView.Builder setLinkage(boolean linkage) {
            this.linkage = linkage;
            return this;
        }

        public CustomerOptionsPickerView.Builder setLabels(String label1, String label2, String label3) {
            this.label1 = label1;
            this.label2 = label2;
            this.label3 = label3;
            return this;
         ...
         */
        public CustomerOptionsPickerView.Builder setLineSpacingMultiplier(float lineSpacingMultiplier) {
         ...
         * @param dividerColor
         */
        public CustomerOptionsPickerView.Builder setDividerColor(int dividerColor) {
         ...
         * @param dividerType
         */
        public CustomerOptionsPickerView.Builder setDividerType(WheelView.DividerType dividerType) {
         ...
         */
        public CustomerOptionsPickerView.Builder setTextColorCenter(int textColorCenter) {
         ...
         * @param textColorOut
         */
        public CustomerOptionsPickerView.Builder setTextColorOut(int textColorOut) {
            this.textColorOut = textColorOut;
            return this;
        }

        public CustomerOptionsPickerView.Builder setTypeface(Typeface font) {
            this.font = font;
            return this;
        }

        public CustomerOptionsPickerView.Builder setCyclic(boolean cyclic1, boolean cyclic2, boolean cyclic3) {
        ...
        public CustomerOptionsPickerView.Builder setSelectOptions(int option1) {
            this.option1 = option1;
            return this;
        }

        public CustomerOptionsPickerView.Builder setSelectOptions(int option1, int option2) {
            this.option1 = option1;
            this.option2 = option2;
            return this;
        }

        public CustomerOptionsPickerView.Builder setSelectOptions(int option1, int option2, int option3) {
            this.option1 = option1;
            this.option2 = option2;
        ...
        public CustomerOptionsPickerView.Builder isCenterLabel(boolean isCenterLabel) {
            this.isCenterLabel = isCenterLabel;
            return this;
        }

        public CustomerOptionsPickerView build() {
    ...
    public void onClick(View v) {
        ...
        if (tag.equals(TAG_SUBMIT)) {
            ...
            optionCancelListener.onOptionCancelListener();
        }
        dismiss();
    }
