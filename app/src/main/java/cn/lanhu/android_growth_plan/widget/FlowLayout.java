...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childView.getTag() != null && childView.getTag().equals("add")) {
                tagChildView = childView;
            } else {
                measureMyChild(childView, widthMeasureSpec, heightMeasureSpec);
            }
        }
        if(tagChildView != null) {
            measureMyChild(tagChildView, widthMeasureSpec, heightMeasureSpec);
        }
        // ******************** 测量自己 *********************
    ...
    public class Line {
        ...
        public void layout(int t, int l) {
            ...
            for (View view : views) {
                ...
                // 重新测量
                view.measure(MeasureSpec.makeMeasureSpec(measuredWidth + avg, MeasureSpec.AT_MOST),
