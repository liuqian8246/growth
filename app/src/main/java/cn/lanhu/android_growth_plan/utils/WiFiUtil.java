package cn.lanhu.android_growth_plan.utils;
...
public class WiFiUtil {
     ...
     * @param hindden
     */
    public int addWiFiNetwork(String SSID, String password, Data type, boolean hindden) {
        // 创建WiFi配置
        WifiConfiguration configuration = createWifiConfig(SSID, password, type, hindden);
     ...
     * @return
     **/
    private WifiConfiguration createWifiConfig(String SSID, String password, Data type, boolean hiddenSSID) {
        Log.e("hiddenSSID-->", hiddenSSID + "");
