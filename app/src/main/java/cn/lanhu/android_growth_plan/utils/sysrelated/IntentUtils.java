...
public class IntentUtils {
    ...
    public static class Builder {
        ...
        public Builder setStringArrayListExtra(String key, ArrayList<String> value) {
            mIntent.putExtra(key, value);
            return this;
        }
    ...
    public void startActivityAnim() {
        mContext.startActivity(mIntent);
        ((Activity) mContext).overridePendingTransition(R.anim.anim_enter3, R.anim.anim_exit3);
    }
